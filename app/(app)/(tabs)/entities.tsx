    ...
    return (
      <View className="flex-1 items-center justify-center px-8 pt-20">
        ...
        <Pressable
          ...
          className="mt-5 flex-row items-center rounded-lg bg-indigo-600 px-4 py-2.5 active:bg-indigo-700 dark:bg-indigo-500 dark:active:bg-indigo-600"
        >
    ...
    <View className="flex-1 bg-stone-50 dark:bg-stone-950">
      ...
      {isLoading && entities.length === 0 ? (
        <View className="flex-1 items-center justify-center">
          ...
          <Text className="mt-3 text-sm text-stone-400 dark:text-stone-500">Loading entities...</Text>
        </View>
      ) : (
        <FlatList
          data={entities}
