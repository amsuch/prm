    ...
    return (
      <View className="flex-1 items-center justify-center px-8 pt-20">
        ...
        <Pressable
          ...
          className="mt-5 flex-row items-center rounded-lg bg-blue-600 px-4 py-2.5 active:bg-blue-700"
        >
    ...
    <View className="flex-1 bg-gray-50">
      ...
      {isLoading && entities.length === 0 ? (
        <View className="flex-1 items-center justify-center">
          ...
          <Text className="mt-3 text-sm text-gray-400">Loading entities...</Text>
        </View>
      ) : (
        <FlatList
          data={entities}
